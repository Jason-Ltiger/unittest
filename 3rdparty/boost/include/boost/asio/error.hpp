...
#if (defined __GNUC__)
#define BOOST_USER_UNUSED __attribute__((unused))
#else
#define BOOST_USER_UNUSED
#endif
static const BOOST_USER_UNUSED boost::system::error_category& system_category
  = boost::asio::error::get_system_category();
static const BOOST_USER_UNUSED boost::system::error_category& netdb_category
  = boost::asio::error::get_netdb_category();
static const BOOST_USER_UNUSED boost::system::error_category& addrinfo_category
  = boost::asio::error::get_addrinfo_category();
static const BOOST_USER_UNUSED boost::system::error_category& misc_category
  = boost::asio::error::get_misc_category();
#undef BOOST_USER_UNUSED
